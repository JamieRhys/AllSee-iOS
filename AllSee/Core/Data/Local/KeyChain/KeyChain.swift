...
final class KeyChain {
    ...
    static func insertToken(_ token: Data, identifier: String, service: String) throws {
        let attributes = [
    ...
    ///   - service: The service to store related tokens under. This is normally the package structure for the app.
    static func updateToken(_ token: Data, identifier: String, service: String) throws {
        let query = [
            kSecClass: kSecClassGenericPassword,
            kSecAttrService: service,
            kSecAttrAccount: identifier,
    ...
    ///   - service: The service to store related tokens under. This is normally the package structure for the app.
    static func upsertToken(_ token: Data, identifier: String, service: String) throws {
        do {
    ...
    ///   - service: The service to store related tokens under. This is normally the package structure for the app.
    static func deleteToken(identifier: String, service: String) throws {
        let query = [
            kSecClass: kSecClassGenericPassword,
            kSecAttrService: service,
            kSecAttrAccount: identifier,
